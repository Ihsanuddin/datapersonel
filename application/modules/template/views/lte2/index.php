...
<html>
  <head>
    ...
    <!-- Icheck -->
    <link rel="stylesheet" href="<?php echo base_url()?>assets/template/lte2/plugins/iCheck/all.css">
    ...
    <!-- Freez Table -->
    <script src="<?php echo base_url()?>assets/template/lte2/plugins/CongelarFilaColumna/js/jquery.CongelarFilaColumna.js"></script>
<!-- icheck -->
<script type="text/javascript" src="<?php echo base_url('assets/template/lte2/plugins/iCheck/icheck.min.js'); ?>"></script>
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css"> -->
  </head>
  <body class="hold-transition skin-red sidebar-mini <?php if(!empty($collapse_sidebar)){ echo $collapse_sidebar;}; ?>">
    <div class="wrapper">
    ...
    <script src="<?php echo base_url(); ?>assets/template/lte2/plugins/ckeditor/ckeditor.js"></script>
