<script type="text/javascript">
    ...
    function add_area()
    {
      ...
      $('.modal-title').text('Tambah Area'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_area(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.areaID);
            $('[name="areaName"]').val(data.areaName);
            $('[name="areaNote"]').val(data.areaNote);
...
<section class="content">
	<button class="btn btn-primary" onclick="add_area()"><i class="glyphicon glyphicon-plus"></i> Tambah Area</button>
	<p></p>
		...
		<div class="modal-content">
          ...
          <div id="msg-container"></div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea name="areaNote" class="form-control">
