...
// $("#containerLoad").load("<?php echo base_url('terimaproduksiotbgbb/load_add'); ?>", function(response, status, xhr) {
//   // body...
//   if(status == "success")
//     $('#loading').hide();
//   if(status == "error")
...
$("#buttonAddBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('terimaproduksiotbgbbtl/load_add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBB").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('terimaproduksiotbgbb/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('terimaproduksiotbgbbtl/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
<section class="content">
    ...
    <div id="containerLoad">
      ...
      <?php echo Modules::run('terimaproduksiotbgbb/load_add'); ?>
    </div>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="lshp2tt"/>
