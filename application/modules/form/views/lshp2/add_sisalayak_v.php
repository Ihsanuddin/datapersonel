...
// $("#containerLoad").load("<?php echo base_url('sisalayakpbbhp/add'); ?>", function(response, status, xhr) {
//   // body...
//   if(status == "success")
//     $('#loadingAddSisaLayak').hide();
//     $('#loadingTerpilihSisaLayak').hide();
//   if(status == "error")
...
$("#buttonAddBB").click(function(){
  $('#loadingAddSisaLayak').show();
  $('#loadingTerpilihSisaLayak').show();
  $("#containerLoad").load("<?php echo base_url('sisalayakpbbhp/add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loadingAddSisaLayak').hide();
...
$("#buttonAddBBTL").click(function(){
  $('#loadingAddSisaLayak').show();
  $('#loadingTerpilihSisaLayak').show();
  $("#containerLoad").load("<?php echo base_url('sisalayakpbbtlhp/add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loadingAddSisaLayak').hide();
      $('#loadingTerpilihSisaLayak').hide();
...
<section class="content">
    <button id="buttonAddBB" class="btn btn-primary">Input SL BB <i class="fa fa-plus"></i></button>
    <button id="buttonAddBBTL" class="btn btn-primary">Input SL BBTL <i class="fa fa-plus"></i></button>
    ...
    <div id="containerLoad">
      ...
      <?php echo Modules::run('sisalayakpbbhp/add'); ?>
    </div>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="lshp2sl"/>
