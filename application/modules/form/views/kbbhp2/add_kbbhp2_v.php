...
// $("#containerLoad").load("<?php echo base_url('pbbhp/load_add_pbbhp'); ?>", function(response, status, xhr) {
//   // body...
//   if(status == "success")
//     $('#loading').hide();
//   if(status == "error")
...
$("#buttonAddBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('pbbtlhp/load_add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBB").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('pbbhp/load_terpilih_pbbhp'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('pbbtlhp/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
<section class="content">
    ...
    <div id="containerLoad">
      ...
      <?php echo Modules::run('pbbhp/load_add_pbbhp'); ?>
    </div>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="kbbhp2"/>
