<script type="text/javascript">
  ...
  {
    $("#containerLoad").load("<?php echo base_url('kbbmp/load_add'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
    ...
    $("#buttonAddBBTL").click(function(){
      ...
      $("#containerLoad").load("<?php echo base_url('kbbmobbtl/load_add'); ?>", function(response, status, xhr) {
        // body...
        if(status == "success")
          $('#loading').hide();
    ...
    $("#buttonAddBBOPS").click(function(){
      ...
      $("#containerLoad").load("<?php echo base_url('kbbmobbops/load_add'); ?>", function(response, status, xhr) {
        // body...
        if(status == "success")
          $('#loading').hide();
    ...
    $("#buttonDaftarTerpilihBB").click(function(){
      $('#loading').show();
      $("#containerLoad").load("<?php echo base_url('kbbmp/load_terpilih'); ?>", function(response, status, xhr) {
        // body...
        if(status == "success")
          $('#loading').hide();
        if(status == "error")
    ...
    $("#buttonDaftarTerpilihBBTL").click(function(){
      $('#loading').show();
      $("#containerLoad").load("<?php echo base_url('kbbmobbtl/load_terpilih'); ?>", function(response, status, xhr) {
        // body...
        if(status == "success")
          $('#loading').hide();
        if(status == "error")
    ...
    $("#buttonDaftarTerpilihBBOPS").click(function(){
      $('#loading').show();
      $("#containerLoad").load("<?php echo base_url('kbbmobbops/load_terpilih'); ?>", function(response, status, xhr) {
        // body...
        if(status == "success")
          $('#loading').hide();
        if(status == "error")
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="kbbm"/>
