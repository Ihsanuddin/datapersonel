...
$(document).ready(function(){
  $("#buttonAddBB").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbhp/load_add'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#buttonAddBBTL").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbtlhp/load_add'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#buttonAddBBOPS").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbopsho/load_add'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#buttonDaftarTerpilihBB").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbhp/load_terpilih'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#buttonDaftarTerpilihBBTL").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbtlhp/load_terpilih'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#buttonDaftarTerpilihBBOPS").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbopsho/load_terpilih'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
        $('#loading').hide();
      if(status == "error")
  ...
  $("#refreshaddkgpbbhp").click(function(){
    $('#loading').show();
    $("#containerLoad").load("<?php echo base_url('keluargudangpbbhp/load_add'); ?>", function(response, status, xhr) {
      // body...
      if(status == "success")
...
<section class="content">
    ...
    <div id="containerLoad">
      <?php echo Modules::run('keluargudangpbbhp/load_add'); ?>
    </div>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="lshgkg"/>
