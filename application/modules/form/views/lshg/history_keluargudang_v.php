...
$("#containerLoad").load("<?php echo base_url('keluargudangpbbhp/load_history/'.date('Y-m-d')); ?>", function(response, status, xhr) {
  // body...
  if(status == "success")
    $('#loading').hide();
  if(status == "error")
...
<div class="modal fade" id="modal_priode" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
          <form id="frmpriode" class="form-horizontal" action="<?php echo base_url('keluargudangpbbhp/search_history/'); ?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select class="form-control" name="jenis" id="jenis">
                      <option value="keluargudangpbbhp">Keluar Gudang BB</option>
                      <option value="keluargudangpbbtlhp">Keluar Gudang BBTL</option>
                      <option value="keluargudangpbbopsho">Keluar Gudang BBOPS</option>
                    </select>
                  </div>
                </div>
            </div>
