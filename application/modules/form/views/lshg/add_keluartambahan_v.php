...
$("#containerLoad").load("<?php echo base_url('keluargudangotbgbb/load_add'); ?>", function(response, status, xhr) {
  // body...
  if(status == "success")
    $('#loading').hide();
  if(status == "error")
...
$("#buttonAddBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('keluargudangotbgbbtl/load_add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonAddBBOPS").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('keluargudangotbgbbops/load_add'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBB").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('keluargudangotbgbb/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBBTL").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('keluargudangotbgbbtl/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
...
$("#buttonDaftarTerpilihBBOPS").click(function(){
  $('#loading').show();
  $("#containerLoad").load("<?php echo base_url('keluargudangotbgbbops/load_terpilih'); ?>", function(response, status, xhr) {
    // body...
    if(status == "success")
      $('#loading').hide();
    if(status == "error")
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="form" value="lshgkt"/>
