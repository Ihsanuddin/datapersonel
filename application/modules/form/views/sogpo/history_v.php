...
$("#containerLoad").load("<?php echo base_url('sobbgp/load_history/'.date('Y-m-d')); ?>", function(response, status, xhr) {
  // body...
  if(status == "success")
    $('#loadingHistory').hide();
  if(status == "error")
...
<div class="modal fade" id="modal_priode" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
          <form id="frmpriode" class="form-horizontal" action="<?php echo base_url('sobbgp/search_history/'); ?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select class="form-control" name="jenis" id="jenis">
                      <option value="sobbgp">Stock Opname BB</option>
                      <option value="sobbbbtl">Stock Opname BBTL</option>
                      <option value="sobbbbops">Stock Opname BBOPS</option>
                    </select>
                  </div>
                </div>
            </div>
